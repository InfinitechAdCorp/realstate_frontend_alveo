              ...
              >
                ...
                {loading ? (
                  ...
                  fetchedData.map((property, index) => (
                    ...
                    >
                      <h2 className='text-4xl text-center font-thin text-white'>
                        Property Details
                      </h2>

                      <div
                        className='property-card-header flex items-center 
                      ...
                      >
                        ...
                        <a href={`/pages/buildings/${property.id}`}>
                          ...
                          text-white underline py-2 px-4 rounded-lg 
                      ...
                      <div className='features-section space-y-8 flex flex-col items-center justify-center'>
                        <span className='section-title text-3xl font-thin 
                        text-white tracking-tight text-center uppercase'>
                          Building Facilities
                        </span>
                        <ul className='features-list grid grid-cols-2 
                         w-full max-w-4xl'>
                          {property.features &&
                        ...
                        {property.buildings && property.buildings.length > 0 && (
                          <div className='mt-6 w-auto flex justify-center'>
                            <div className='w-auto max-w-4xl'>
                              ...
                              text-gray-800 tracking-wide uppercase'
                              >
                                Building Layout
                              </span>
