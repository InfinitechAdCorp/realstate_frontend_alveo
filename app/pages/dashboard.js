          ...
          >
            ...
            {selectedLocation && (
              <div className='absolute top-2.5 left-2.5 p-4 bg-white/90 shadow-lg rounded-lg z-50'>
                ...
                />
                <Link
                  href={`/pages/buildings/${selectedLocation.id}`}
                  passHref
                  className='no-underline'
                >
                  <button
          ...
          <div className='relative w-full h-auto rounded-lg overflow-hidden cursor-pointer z-10'>
            ...
            >
              <Image
                ...
                } w-80 xl:w-full 2xl:w-full h-full`} // Ensure the image takes the full container space
                        ...
                        (imgPath, imgIndex) => {
                          ...
                          const imageSrc =
                            ...
                            imgPath.startsWith('https')
                              ...
                              : `http://localhost:8000/${imgPath.replace(
                                  /\\/g,
                                  '/'
