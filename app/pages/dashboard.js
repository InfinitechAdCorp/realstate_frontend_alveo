                    ...
                    >
                      ...
                      <div className="property-card-header flex items-center justify-between gap-5">
                        ...
                        <a href={`/pages/buildings/${property.id}`}>
                          <h2 className="font-semibold text-right text-blue-600 underline py-2 px-4 rounded-lg cursor-pointer hover:bg-blue-100 transition-all duration-300 text-lg">
