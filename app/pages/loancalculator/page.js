  ...
  return (
    <>
      ...
      >
        ...
        <section className="relative z-20 text-customBlue w-full max-w-7xl p-6 bg-white shadow-xl rounded-lg">
          <h1 className="mb-5 font-semibold text-3xl text-white border-t-2 w-fit mx-auto border-white">
            LOAN CALCULATOR
          </h1>
          ...
          <div className="mt-6 text-center">
            ...
            <button
              onClick={exportPDF}
              className="mt-6 px-6 py-3 bg-customBlue text-white hover:bg-blue-700"
            >
              Export as PDF
            </button>
          </div>
