...
export default function SEO({ title, description, keywords, canonical }) {
  return (
    <Head>
      ...
      <link rel="canonical" href={canonical || 'https://realstate-frontend-alveo.vercel.app/'} />
      ...
      <meta property="og:url" content={canonical || 'https://realstate-frontend-alveo.vercel.app/'} />
